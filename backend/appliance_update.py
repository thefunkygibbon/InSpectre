...
def recreate(client, name, image_ref=None) -> dict:
    ...
    host_config = api.create_host_config(
        ...
        runtime=hostcfg.get("Runtime") or None,
        cap_add=hostcfg.get("CapAdd") or None,
        cap_drop=hostcfg.get("CapDrop") or None,
        devices=devices or None,
        dns=hostcfg.get("Dns") or None,
        dns_search=hostcfg.get("DnsSearch") or None,
        extra_hosts=_parse_extra_hosts(hostcfg.get("ExtraHosts")),
        sysctls=hostcfg.get("Sysctls") or None,
        mem_limit=hostcfg.get("Memory") or None,
        nano_cpus=hostcfg.get("NanoCpus") or None,
        log_config=hostcfg.get("LogConfig") or None,
        pid_mode=hostcfg.get("PidMode") or None,
        ipc_mode=hostcfg.get("IpcMode") or None,
        userns_mode=hostcfg.get("UsernsMode") or None,
        security_opt=hostcfg.get("SecurityOpt") or None,
        tmpfs=hostcfg.get("Tmpfs") or None,
        shm_size=hostcfg.get("ShmSize") or None,
        read_only=hostcfg.get("ReadonlyRootfs", False),
    ...
    try:
        created = api.create_container(
            ...
            stop_timeout=hostcfg.get("StopTimeout"),
            ports=exposed,
